...
!function(t) {
    ...
    r.prototype = {
        ...
        initialize: function() {
            ...
            (e = s.suggestionsContainer).on("mouseover.autocomplete", i, function() {
        ...
        fixPosition: function() {
            ...
            if (s === document.body || this.options.forceFixPosition) {
                ...
                if (this.el.closest(".pop-up-live-search").length > 0) {
                    ...
                    if (is_RTL)
                        var u = Math.floor(l.left + this.el.outerWidth() - this.options.width + 1);
                    else
                        u = Math.floor(l.left - 1);
                    var h = {
                        top: l.top,
                        left: u
                    }
                    ...
                    if (is_RTL)
                        ...
                        u = Math.floor(l.left + this.el.outerWidth() - this.options.width + 1);
                    h = {
                        top: l.top,
                        left: u
                    }
            ...
            if (this.disabled || this.visible || t.which !== a || !this.currentValue) {
                if (!this.disabled && this.visible) {
                    ...
                    case i:
                        ...
                        if (this.select(this.selectedIndex), !1 === this.options.tabDisabled)
                            return;
                        break;
                    case n:
                        if (-1 === this.selectedIndex)
        ...
        onKeyUp: function(t) {
            ...
            if (!e.disabled) {
                ...
                e.currentValue !== e.el.val() && (e.findBestHint(), e.options.deferRequestBy > 0 ? e.onChangeInterval = setInterval(function() {
                    e.onValueChange()
        ...
        onValueChange: function() {
            var e = this.options,
                s = this.el.val(),
                i = this.getQuery(s);
            this.selection && this.currentValue !== i && (this.selection = null, (e.onInvalidateSelection || t.noop).call(this.element)),
            clearInterval(this.onChangeInterval),
            this.currentValue = s,
            this.selectedIndex = -1,
            e.triggerSelectOnValidInput && this.isExactMatch(i) ? this.select(0) : i.length < e.minChars ? this.hide() : this.getSuggestions(i)
        },
        ...
        getSuggestions: function(e) {
            ...
            !1 !== a.onSearchStart.call(l.element, a.params) && (t.isFunction(a.lookup) ? a.lookup(e, function(t) {
        ...
        suggest: function() {
            if (0 !== this.suggestions.length) {
                ...
                s.triggerSelectOnValidInput && this.isExactMatch(o) ? this.select(0) : (t.each(this.suggestions, function(t, s) {
                    ...
                    c += '<div class="' + l + '" data-index="' + t + '">' + n(s, o) + "</div>"
        ...
        signalHint: function(e) {
            ...
            this.hintValue !== s && (this.hintValue = s, this.hint = e, (this.options.onHint || t.noop)(s))
        },
        ...
        processResponse: function(t, e, s) {
            ...
            i.noCache || (this.cachedResponse[s] = t, i.preventBadQueries && 0 === t.suggestions.length && this.badQueries.push(e)),
        ...
        moveUp: function() {
            if (-1 !== this.selectedIndex)
                return 0 === this.selectedIndex ? (this.suggestionsContainer.children().first().removeClass(this.classes.selected), this.selectedIndex = -1, this.el.val(this.currentValue), void this.findBestHint()) : void this.adjustScroll(this.selectedIndex - 1)
        },
        moveDown: function() {
        ...
        adjustScroll: function(e) {
            ...
            if (s) {
                var i,
                    ...
                    l = t(s).outerHeight();
                i = s.offsetTop,
                o = (n = this.suggestionsContainer.scrollTop()) + this.options.maxHeight - l,
                i < n ? this.suggestionsContainer.scrollTop(i) : i > o && this.suggestionsContainer.scrollTop(i - this.options.maxHeight + l),
                this.options.preserveInput || this.el.val(this.getValue(this.suggestions[e].value)),
                this.signalHint(null)
            }
        },
        onSelect: function(e) {
