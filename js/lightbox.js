    ...
    fa.prototype = {
        ...
        moveTo: function(a) {
            ...
            n.addClass(C).css(B, H).animate({
                ...
                "next" == a ? (c.nextPhoto = m, c.prevPhoto = n, c.holder = k, c.nextPhoto.hide(), c.next += 1, c.prev = c.current, c.current += 1, d.infinite && (c.current > c.total - 1 && (c.current = 0), c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.next] ? b.loadContent(b.items[c.next], "next") : c.nextLock = !1) : (c.prevPhoto = m, c.nextPhoto = n, c.holder = k, c.prevPhoto.hide(), c.next = c.current, c.current = c.prev, c.prev = c.current - 1, d.infinite && (c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.prev] ? b.loadContent(b.items[c.prev], "prev") : c.prevLock = !1);
        ...
        addContent: function(a, b) {
            ...
            case "html":
                c = b.URL,
                c[0].nodeName || (c = g(b.URL), c = c.selector ? g("<div>" + c + "</div>") : c),
...
!function(a, b, c) {
    for (var e, d = 0, f = function(a) {
        ...
        }, g = ["ms", "moz", "webkit", "o"], h = 0, i = g.length; h < i && !b.requestAnimationFrame; ++h)
